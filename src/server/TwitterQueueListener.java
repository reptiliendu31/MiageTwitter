            ...
            try {
                switch (message.getJMSType()) {
                    case "InitTempQueue" :
                        ...
                        break;
                    // twitterqueuelistener
                    case "Connection" :
                        serverId = mess.readInt();
                        String login = mess.readString();
                        String password = mess.readString();
                        String localisation = mess.readString();
                        server.respConnection(serverId,login,password,localisation);
                        break;
                    case "SignIn" :
                        serverId = mess.readInt();
                        ...
                        String localisationS = mess.readString();
                        server.respSignIn(serverId, loginS, passwordS, nameS, firstNameS, localisationS);
                        break;
                    case "SignOut" :
                        serverId = mess.readInt();
                    ...
                    case "Search" :
                        serverId = mess.readInt();
                        String search = mess.readString();
                        server.respSearch(serverId, search);
                        break;
                    case "Tweet" :
                        serverId = mess.readInt();
